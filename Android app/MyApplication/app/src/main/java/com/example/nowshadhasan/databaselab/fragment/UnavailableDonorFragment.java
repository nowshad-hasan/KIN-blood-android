...
public class UnavailableDonorFragment extends ListFragment {
    ...
    private String TAG=UnavailableDonorFragment.class.getSimpleName();
    ...
    public UnavailableDonorFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_unavailable_donor, container, false);
...
//        String ipAddress="10.100.170.46";
        ...
        String url="http://"+preferences.getString("IPAddress",null)+":8080/DatabaseLab/UnavailableDonorServlet?BloodGroup="+bloodGroup;
//String url="http://localhost:8080/DatabaseLab/AvailableDonorServlet?BloodGroup=B+";
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    jsonArray = response.getJSONArray("unavailableDonor");
