 ...
 */
public class HomeFragment extends ListFragment implements MaterialSearchView.OnQueryTextListener,MaterialSearchView.SearchViewListener{
...
//        String ipAddress="10.100.170.46";
        ...
        String url="http://"+preferences.getString("IPAddress",null)+":8080/DatabaseLab/AvailableDonorServlet?BloodGroup="+bloodGroup;
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
              //  Log.e(TAG,"OK from fragment");
                ...
                try {
                    jsonArray = response.getJSONArray("availableDonor");
